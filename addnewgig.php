                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-4 border-end border-success">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">sirvise Category</label>
                                        </div>
                                ...
                                <div class="col-12 col-lg-4 border-end border-success">
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">SUB category</label>
                                        </div>
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-4 border-end border-success">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-label fw-bold" style="font-size: 20px;">Select sirvise packege</label>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-check form-check-inline mx-5">
                                                        <input class="form-check-input" type="radio" id="b" name="c" checked />
                                                        <label class="form-check-label fw-bold" for="b">silver</label>
                                                    </div>
                                                    <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" id="u" name="c" />
                                                        <label class="form-check-label fw-bold" for="u">Gold</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-label fw-bold" style="font-size: 20px;">IN how meny days</label>
                                                </div>
                                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <div class="col-6 border-end border-success">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="form-label fw-bold" style="font-size: 20px;">Cost Per sirvise</label>
                                                </div>
                                                <div class="offset-0 offset-lg-2 col-12 col-lg-8">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="form-label fw-bold" style="font-size: 20px;">for extra sirvise </label>
                                        </div>
                                        <div class="col-12 col-lg-6 border-end border-success">
                                            <div class="row">
                                                <div class="col-12 offset-lg-1 col-lg-3">
                                                    <label class="form-label">Within 2 days</label>
                                                </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="row">
                                                <div class="col-12 offset-lg-1 col-lg-3">
                                                    <label class="form-label">within 24 Hours</label>
                                                </div>
                                                <div class="col-12 col-lg-8">
                                                    <div class="input-group mb-2 mt-2">
                                                        <span class="input-group-text">Rs.</span>
